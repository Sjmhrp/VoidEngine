...
public class Matrix3d implements Serializable{
	...
	public Matrix3d setSymmetric(Matrix3d m) {
		return setSymmetric(m.m00,m.m01,m.m02,m.m11,m.m12,m.m22);
	}
	
	public Matrix3d setSymmetric(double m00, double m01, double m02, double m11, double m12, double m22) {
		return set(m00,m01,m02,m01,m11,m12,m02,m12,m22);
	}
	...
	public Matrix3d load(DoubleBuffer buf) {
		m00=buf.get();
		m10=buf.get();
		m20=buf.get();
		m01=buf.get();
